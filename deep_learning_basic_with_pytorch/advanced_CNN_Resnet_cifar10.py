...
#     transforms.ToTensor(),
#     transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5)) # normalize with arbitrary value
# ])
...
trainset = torchvision.datasets.CIFAR10(root='./cifar10',
                                        ...
                                        download=True,
                                        transform=transform)
# https://github.com/khanrc/pt.darts/issues/11
# print(trainset.train_data.shape)
print(trainset.data.shape)

# calculates mean and std of each axis
